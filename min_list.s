...
movl %ecx, %ebx # We keep track of minimum till now in %ebx. It's the list's first item at the start
...
# to find the minimum in the list we need to keep track of 
# - current index we are at - %eax
# - minimum till now - %ebx
